...
**All trading recommendations are generated by Claude 3.5 Sonnet** (no rule-based fallback):
...
**Cost Optimization:**
- Cache recommendations for 5 minutes (configurable)
- Only re-analyze on significant position changes (>5% P/L move)
- Batch analysis for multiple positions in portfolio view
